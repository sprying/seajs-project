    ...
    $.extend($.validator, {
        ...
        prototype: {
            ...
            customDataMessage: function(element, method) {
                var midValue = method[0] ? method[0] : method.charAt(0).toUpperCase() + method.substring(1).toLowerCase();
                return $(element).data("msg" + midValue) || $(element).data("msg");
            },
        ...
        dataRules: function(element) {
            ...
            for (method in $.validator.methods) {
                var midVaule = method[0] ? method[0] : method.charAt(0).toUpperCase() + method.substring(1).toLowerCase();
                value = $element.data("rule" + midVaule);
                if (value !== undefined) {
                    rules[method] = value;
                }
            }
...
define("widget/validator/1.12.0/jquery.validate-debug", [], function() {});